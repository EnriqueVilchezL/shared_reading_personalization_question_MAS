...
from shared_reading_mas.roles.questions.edition_critic import EditionCriticRole
...
class EditionCriticAgent(Agent):
    ...
    def pre_core(self, data: dict) -> dict:
        ...
        query = "Porfavor, asigna una etiqueta a las intervenciones de este cuento."
        renderer = BookMarkdownRenderer()

        request = HumanMessage(
            query
            + "\n\n**Cuento original con Intervencioens CROWD**:\n"
